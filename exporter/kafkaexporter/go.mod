...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kafka v0.137.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.137.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/kafka/configkafka v0.137.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/kafka/topic v0.137.0
	...
	go.opentelemetry.io/collector/exporter/xexporter v0.137.0
	...
	go.opentelemetry.io/collector/pdata/testdata v0.137.0
