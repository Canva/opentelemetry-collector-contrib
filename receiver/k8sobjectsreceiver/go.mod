...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sinventory v0.152.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sleaderelectortest v0.152.0
