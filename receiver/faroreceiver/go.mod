...
require go.opentelemetry.io/collector/extension/extensionauth v1.58.0 // indirect
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/faro v0.152.0
