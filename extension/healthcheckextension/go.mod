...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/healthcheck v0.152.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/internal/healthcheck => ../../internal/healthcheck
