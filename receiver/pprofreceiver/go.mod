...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/pprof v0.152.0
	...
	go.opentelemetry.io/collector/scraper/scraperhelper/xscraperhelper v0.152.0
