...
require (
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/grpcutil v0.152.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/otelarrow v0.152.0
