...
var typ = component.MustNewType("ntp")
...
func TestComponentLifecycle(t *testing.T) {
	...
	tests := []struct {
		...
		name     string
<<<<<<<< HEAD:receiver/opencensusreceiver/generated_component_test.go
		createFn func(ctx context.Context, set receiver.Settings, cfg component.Config) (component.Component, error)
|||||||| 6b1d3dd2c0c:receiver/opencensusreceiver/generated_component_test.go
		createFn func(ctx context.Context, set receiver.CreateSettings, cfg component.Config) (component.Component, error)
========
>>>>>>>> v0.137.0:receiver/ntpreceiver/generated_component_test.go
	}{
